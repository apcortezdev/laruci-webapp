  ...
  return (
    <div className={[styles.page, styles.flex_center].join(' ').trim()}>
      <section className={styles.mosaic}>
        {mosaic.map((pic, index) => (
          <div
            key={pic.src}
            className={
              index < 3 ? styles.mosaic_item_mobile : styles.mosaic_item_web
            }
          >
            <Image
              src={pic.src}
        ...
        <div className={styles.social_container}>
          <span
            className={[styles.social_icon, styles.social_face]
              ...
              .trim()}
          >
            <FacebookIconLink link={'https://facebook.com/' + facebookName} />
          </span>
          <span
          ...
          >
            <InstagramIconLink
              link={'https://instagram.com/' + instagramName}
            />
          </span>
          <span
          ...
          >
            <WhatsappIconLink
              link={`https://wa.me/${whatsappNum}?text=${encodeURIComponent(
                whatsappMessage
              )}`}
            />
          </span>
          ...
          <table>
            <tbody>
              ...
              <tr>
                <td>
                  {phoneSac.map((phone) => {
                    let text = phone.startsWith('55') ? phone.slice(2) : phone;
                    let mask;
